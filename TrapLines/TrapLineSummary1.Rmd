...
par(mar=rep(0, 4))
with(catch12m, plot(E, S, cex=0.4, col='grey50', axes=FALSE, xlab='', ylab=''))
i <- 4
for (i in 4:ncol(catch12m))
{  
  points(catch12m[catch12m[,i]!=0, c('E', 'S')], cex=cumCatch[catch12m[,i]!=0, 4]/2,
       pch=16, col=paste0('grey', seq(8, 96, 8)[i-3]))
}
```
