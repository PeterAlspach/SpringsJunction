...
<!-- To do: -->
<!-- Mammals are defined at the end of the 'getReady' chunk (about line 47) -->
...
# cutDays <- obsMth$cutDays
# obsMth <- obsMth$obsMth
...
```{r currMth}
catch <- consolidateTrapData(currMth=mth)
```
...
miscSppM <- table(unlist(tl[obsMth==levels(obsMth)[mth-1], c('Trap.1','Trap.2')]))
```
